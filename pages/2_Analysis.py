...
def feature_dist(data):
    ...
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="FEATURE DESCRIPTION",ln=True,align='J',border=True,fill=True)
    ...
    st.session_state["pdf_report"].set_line_width(3)
    st.session_state["pdf_report"].set_text_color(255,255,255)
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="INSIGHTS ON DATASET",ln=True,align='J',border=True,fill=True)
    st.session_state["pdf_report"].set_text_color(0,0,0)
    st.session_state["pdf_report"].set_line_width(0.1)
    st.session_state["pdf_report"].set_draw_color(30,30,30)
    st.session_state["pdf_report"].set_fill_color(255,255,255)
    ...
    st.session_state["pdf_report"].set_line_width(3)
    st.session_state["pdf_report"].set_text_color(255,255,255)
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="INSIGHTS ON NULL DATA",ln=True,align='J',border=True,fill=True)
    st.session_state["pdf_report"].set_text_color(0,0,0)
    st.session_state["pdf_report"].set_line_width(0.1)
    st.session_state["pdf_report"].set_draw_color(30,30,30)
    st.session_state["pdf_report"].set_fill_color(255,255,255)
    ...
    st.session_state["pdf_report"].set_line_width(3)
    st.session_state["pdf_report"].set_text_color(255,255,255)
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="FEATURE DISTRIBUTION",ln=True,align='J',border=True,fill=True)
    st.session_state["pdf_report"].set_text_color(0,0,0)
    st.session_state["pdf_report"].set_line_width(0.1)
    st.session_state["pdf_report"].set_draw_color(30,30,30)
    st.session_state["pdf_report"].set_fill_color(255,255,255)
...
def outlier_plot(data):
    ...
    st.session_state["pdf_report"].set_line_width(3)
    st.session_state["pdf_report"].set_text_color(255,255,255)
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="OUTLIER DETECTION",ln=True,align='J',border=True,fill=True)
    st.session_state["pdf_report"].set_text_color(0,0,0)
    st.session_state["pdf_report"].set_line_width(0.1)
    st.session_state["pdf_report"].set_draw_color(30,30,30)
    st.session_state["pdf_report"].set_fill_color(255,255,255)
...
def correlation_plot(data):
    ...
    st.session_state["pdf_report"].set_line_width(3)
    st.session_state["pdf_report"].set_text_color(255,255,255)
    st.session_state["pdf_report"].multi_cell(w=st.session_state["prin_w"],txt="CORRELATION BETWEEN FEATURES",ln=True,align='J',border=True,fill=True)
    st.session_state["pdf_report"].set_text_color(0,0,0)
    st.session_state["pdf_report"].set_line_width(0.1)
    st.session_state["pdf_report"].set_draw_color(30,30,30)
    st.session_state["pdf_report"].set_fill_color(255,255,255)
